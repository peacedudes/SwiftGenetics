...
final public class LivingTradeGene<GeneType: TreeGeneType>: Gene {
    ...
    public init(_ template: TreeGeneTemplate<GeneType>, geneType: GeneType, parent: LivingTradeGene?, children: [LivingTradeGene], allowsCoefficient: Bool = true) {
